...
root = '/home/cobr/Documents/NRC/FULL_CAL_TEST/SERPENS_SOUTH/450/'  # the root of the data folder
files = os.listdir(root)  # listing all the files in root.

FirstEpoch = fits.open('/home/cobr/Documents/NRC/FULL_CAL_TEST/SERPENS_SOUTH/450/SERPENS_SOUTH_20160202_00058_450_EA3.fit')
...
MetaData = np.loadtxt('/home/cobr/Documents/NRC/data/SERPENS_SOUTH/450/SERPENS_SOUTH_450_EA3_cal_metadata.txt', dtype='str')
meta_dates = []
...
# =================
form = '%s'
np.savetxt('/home/cobr/Documents/NRC/FULL_CAL_TEST/TABLES/FCT_SERPENS_SOUTH_450.table',
           li[1:],
           fmt=form,
           header=hdr
           )
