...
root = '/home/cobr/Documents/NRC/FULL_CAL_TEST/NGC2024/850/'  # the root of the data folder
files = os.listdir(root)  # listing all the files in root.

FirstEpoch = fits.open('/home/cobr/Documents/NRC/FULL_CAL_TEST/NGC2024/850/NGC2024_20151216_00049_850_EA3.fit')
...
# =================
form = '%s'
np.savetxt('/home/cobr/Documents/NRC/FULL_CAL_TEST/TABLES/FCT_NGC2024_850.table',
           li[1:],
           fmt=form,
           header=hdr
           )
