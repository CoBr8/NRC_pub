...
root = '/home/cobr/Documents/NRC/FULL_CAL_TEST/IC348/850/'  # the root of the data folder
files = os.listdir(root)  # listing all the files in root.

FirstEpoch = fits.open('/home/cobr/Documents/NRC/FULL_CAL_TEST/IC348/850/IC348_20151222_00019_850_EA3.fit')
...
# =================
form = '%s'
np.savetxt('/home/cobr/Documents/NRC/FULL_CAL_TEST/TABLES/FCT_IC348_850.table',
           li[1:],
           fmt=form,
           header=hdr
           )
