...
root = '/home/cobr/Documents/NRC/FULL_CAL_TEST/OMC23/450/'  # the root of the data folder
files = os.listdir(root)  # listing all the files in root.

FirstEpoch = fits.open('/home/cobr/Documents/NRC/FULL_CAL_TEST/OMC23/450/OMC23_20151226_00036_450_EA3.fit')
...
MetaData = np.loadtxt('/home/cobr/Documents/NRC/data/OMC23/450/OMC23_450_EA3_cal_metadata.txt', dtype='str')
meta_dates = []
for meta in MetaData:
    metadate = meta[1][6:14]
...
# =================
form = '%s'
np.savetxt('/home/cobr/Documents/NRC/FULL_CAL_TEST/TABLES/FCT_OMC23_450.table',
           li[1:],
           fmt=form,
           header=hdr
           )
