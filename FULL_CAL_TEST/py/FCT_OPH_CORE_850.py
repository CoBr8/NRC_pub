...
root = '/home/cobr/Documents/NRC/FULL_CAL_TEST/OPH_CORE/850/'  # the root of the data folder
files = os.listdir(root)  # listing all the files in root.

FirstEpoch = fits.open('/home/cobr/Documents/NRC/FULL_CAL_TEST/OPH_CORE/850/OPH_CORE_20160115_00084_850_EA3.fit')
...
MetaData = np.loadtxt('/home/cobr/Documents/NRC/data/OPH_CORE/850/OPH_CORE_850_EA3_cal_metadata.txt', dtype='str')
meta_dates = []
...
# =================
form = '%s'
np.savetxt('/home/cobr/Documents/NRC/FULL_CAL_TEST/TABLES/FCT_OPH_CORE_850.table',
           li[1:],
           fmt=form,
           header=hdr
           )
