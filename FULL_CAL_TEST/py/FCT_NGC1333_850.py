...
root = '/home/cobr/Documents/NRC/FULL_CAL_TEST/NGC1333/850/'  # the root of the data folder
files = os.listdir(root)  # listing all the files in root.

FirstEpoch = fits.open('/home/cobr/Documents/NRC/FULL_CAL_TEST/NGC1333/850/NGC1333_20151222_00018_850_EA3.fit')
...
MetaData = np.loadtxt('/home/cobr/Documents/NRC/data/NGC1333/850/NGC1333_850_EA3_cal_metadata.txt', dtype='str')
meta_dates = []
...
# =================
form = '%s'
np.savetxt('/home/cobr/Documents/NRC/FULL_CAL_TEST/TABLES/FCT_NGC1333_850.table',
           li[1:],
           fmt=form,
           header=hdr
           )
