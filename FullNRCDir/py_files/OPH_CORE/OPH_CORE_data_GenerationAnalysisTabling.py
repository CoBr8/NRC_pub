...
root = '/home/broughtonco/documents/nrc/data/OPH_CORE/'  # the root of the data folder
files = os.listdir(root)  # listing all the files in root.

FirstEpoch = fits.open('/home/broughtonco/documents/nrc/data/OPH_CORE/OPH_CORE_20160115_00084_850_EA3_cal.fit')
...
for date, (hdu, Vec) in sorted(dictionary1.items(), key=op.itemgetter(0)):  # pulling data from dictionary
    ...
    for data, name in zip(dat, Dat_Titles):  # updating the fits files every time, remove old ones first.
        if os.path.exists('/home/broughtonco/documents/nrc/data/OPH_CORE/GeneratedMapsFits/{}_{}_{}.fit'.format(
                Region_Name, date, name)):
            os.remove('/home/broughtonco/documents/nrc/data/OPH_CORE/GeneratedMapsFits/{}_{}_{}.fit'.format(
                Region_Name, date, name))
        hdu = fits.PrimaryHDU(data)
        hdu.writeto(
            '/home/broughtonco/documents/nrc/data/OPH_CORE/GeneratedMapsFits/{}_{}_{}.fit'.format(Region_Name, date, name))
    ...
    fig1.suptitle('{} OPH_CORE epoch'.format(date))
    fig1.savefig('/home/broughtonco/documents/nrc/data/OPH_CORE/OPH_CORE_plots/epochs/{}'.format(date))
    # # plt.show()
...
MetaData = np.loadtxt('/home/broughtonco/documents/nrc/data/OPH_CORE/OPH_CORE_850_EA3_cal_metadata.txt', dtype='str')
...
fig.savefig('/home/broughtonco/documents/nrc/data/OPH_CORE/OPH_CORE_plots/OPH_CORE_linearFit_radius_{}.png'.format(dist))
# # plt.show()
...
np.savetxt('/home/broughtonco/documents/nrc/data/OPH_CORE/Datafiles/OPH_CORE_TABLE_TOPCAT.table',
           li[1:],
           fmt=form,
           header=hdr
           )
