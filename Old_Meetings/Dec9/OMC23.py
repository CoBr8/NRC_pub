...
for XCorr in XC_epochs:
    ...
    XCorr = XCorr[Y_max - 5:Y_max + 6, X_max - 5:X_max + 6]  # 11x11 box
    ...
    )  # error in calculations# Autocorrelation symmetric Gaussian Fitting
# +========================================+
AC_fit_li = []
...
for epoch in range(len(AC_Data)):
    ...
    BA = Dat_dict[dist][0][epoch][1]
    BA_err = Dat_dict[dist][1][epoch][1]
    MA = Dat_dict[dist][0][epoch][0]
    MA_err = Dat_dict[dist][1][epoch][0]

    BD = Dat_dict_div[dist][0][epoch][1]
    BD_err = Dat_dict_div[dist][1][epoch][1]
    MD = Dat_dict_div[dist][0][epoch][0]
    MD_err = Dat_dict_div[dist][1][epoch][0]
