...
AC_Data = np.load('/home/broughtonco/documents/nrc/data/OMC23/Datafiles/OMC23_AC.npy')
PSD_Data = np.load('/home/broughtonco/documents/nrc/data/OMC23/Datafiles/OMC23_PSD.npy')
radius = np.load('/home/broughtonco/documents/nrc/data/OMC23/Datafiles/OMC23_radius.npy')
