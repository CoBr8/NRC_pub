...
for epoch in range(len(AC_Data)):
    ...
    dat = np.array([e_num, name, jd, elev, t225, rms, *steve_offset, cal_f, cal_f_err,
                    *jcmt_offset,
                    # xc5_offset[5][0][0], xc5_offset_err[5][0], xc5_offset[5][1][0], xc5_offset_err[5][1],
...
form = '%s'
np.savetxt('/home/broughtonco/documents/nrc/data/OMC23/Datafiles/EXTENDED_OMC23_TABLE_TOPCAT.table',
           li[1:],
           fmt=form,
           header=hdr
           )
