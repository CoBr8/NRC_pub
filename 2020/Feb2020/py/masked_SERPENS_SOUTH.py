...
root = '/home/cobr/Documents/NRC/data/SERPENS_SOUTH/850/'  # the root of the data folder
files = os.listdir(root)  # listing all the files in root.

FirstEpoch = fits.open('/home/cobr/Documents/NRC/data/SERPENS_SOUTH/850/SERPENS_SOUTH_20160202_00058_850_EA3_cal.fit')
...
# =================
form = '%s'
np.savetxt('/home/cobr/Documents/NRC/data/SERPENS_SOUTH/850/Datafiles/MASKED_SERPENS_SOUTH.table',
           li[1:],
           fmt=form,
           header=hdr
           )
