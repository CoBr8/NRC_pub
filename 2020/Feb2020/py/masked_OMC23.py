...
root = '/home/cobr/Documents/NRC/data/OMC23/850/'  # the root of the data folder
files = os.listdir(root)  # listing all the files in root.

FirstEpoch = fits.open('/home/cobr/Documents/NRC/data/OMC23/850/OMC23_20151226_00036_850_EA3_cal.fit')
...
# =================
form = '%s'
np.savetxt('/home/cobr/Documents/NRC/data/OMC23/850/Datafiles/MASKED_OMC23.table',
           li[1:],
           fmt=form,
           header=hdr
           )
