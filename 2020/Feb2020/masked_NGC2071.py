...
root = '/home/cobr/Documents/NRC/data/NGC2071/850/'  # the root of the data folder
files = os.listdir(root)  # listing all the files in root.

FirstEpoch = fits.open('/home/cobr/Documents/NRC/data/NGC2071/850/NGC2071_20151226_00052_850_EA3_cal.fit')
...
# =================
form = '%s'
np.savetxt('/home/cobr/Documents/NRC/data/NGC2071/850/Datafiles/MASKED_NGC2071.table',
           li[1:],
           fmt=form,
           header=hdr
           )
