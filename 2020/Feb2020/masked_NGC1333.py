...
root = '/home/cobr/Documents/NRC/data/NGC1333/850/'  # the root of the data folder
files = os.listdir(root)  # listing all the files in root.

FirstEpoch = fits.open('/home/cobr/Documents/NRC/data/NGC1333/850/NGC1333_20151222_00018_850_EA3_cal.fit')
...
# =================
form = '%s'
np.savetxt('/home/cobr/Documents/NRC/data/NGC1333/850/Datafiles/MASKED_NGC1333.table',
           li[1:],
           fmt=form,
           header=hdr
           )
