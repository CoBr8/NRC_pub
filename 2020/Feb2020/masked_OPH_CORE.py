...
root = '/home/cobr/Documents/NRC/data/OPH_CORE/850/'  # the root of the data folder
files = os.listdir(root)  # listing all the files in root.

FirstEpoch = fits.open('/home/cobr/Documents/NRC/data/OPH_CORE/850/OPH_CORE_20160115_00084_850_EA3_cal.fit')
...
# =================
form = '%s'
np.savetxt('/home/cobr/Documents/NRC/data/OPH_CORE/850/Datafiles/MASKED_OPH_CORE.table',
           li[1:],
           fmt=form,
           header=hdr
           )
