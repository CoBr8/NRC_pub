...
args = \
    np.loadtxt('/home/broughtonco/documents/nrc/data/SERPENS_MAIN/Datafiles/SERPENS_MAIN_M_B_table.table', unpack=True)
x = args[0]
...
fig.savefig('/home/broughtonco/documents/nrc/data/SERPENS_MAIN/SERPENS_MAIN_plots/SERPENS_MAIN_MetaData.png')
plt.close()
