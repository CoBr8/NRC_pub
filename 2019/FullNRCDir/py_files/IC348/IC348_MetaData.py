...
args = \
    np.loadtxt('/home/broughtonco/documents/nrc/data/IC348/Datafiles/IC348_M_B_table.table.table', unpack=True)
x = args[0]
...
fig.savefig('/home/broughtonco/documents/nrc/data/IC348/IC348_plots/IC348_MetaData.png')
plt.close()
